...
function jsonSyntaxHighlight(json) {
    ...
    json = json.replace(/"failure line ([0-9]+)"/g, function(match, line) {
        return "<span class='warning'><a href='#logstash_filter_textarea' style='color: inherit' onClick='setLineFocusFilter(" + line + ")'>" + match + "</a></span>"
    })
