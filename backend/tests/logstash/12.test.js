...
describe("Logstash testing", function () {
  ...
  it("should work with trace on", function (done) {
    ...
    chai.request(app)
      ...
      .end((err, res) => {
        ...
        expect(res.body.job_result.stdout).to.match(/failure line 3/);
        expect(res.body.job_result.stdout).to.match(/failure line 9/);
        done();
      });
